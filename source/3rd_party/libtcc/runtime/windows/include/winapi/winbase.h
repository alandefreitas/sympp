...
#define InterlockedCompareExchangePointer(Destination, ExChange, Comperand)    \
    (PVOID)(LONG_PTR) InterlockedCompareExchange(                              \
        (LONG volatile *)(Destination), (LONG)(LONG_PTR)(ExChange),            \
        (LONG)(LONG_PTR)(Comperand))
#endif
...
WINBASEAPI WINBOOL WINAPI
GetOverlappedResult(HANDLE hFile, LPOVERLAPPED lpOverlapped,
...
WINBASEAPI DWORD WINAPI GetModuleFileNameA(HMODULE hModule, LPCH lpFilename,
                                           DWORD nSize);
WINBASEAPI DWORD WINAPI GetModuleFileNameW(HMODULE hModule, LPWCH lpFilename,
                                           DWORD nSize);
...
WINBASEAPI WINBOOL WINAPI FindNextFileW(HANDLE hFindFile,
                                        LPWIN32_FIND_DATAW lpFindFileData);
WINBASEAPI DWORD WINAPI SearchPathA(LPCSTR lpPath, LPCSTR lpFileName,
...
WINBASEAPI WINBOOL WINAPI ReplaceFileW(LPCWSTR lpReplacedFileName,
                                       ...
                                       LPVOID lpReserved);
WINBASEAPI WINBOOL WINAPI
CreateHardLinkA(LPCSTR lpFileName, LPCSTR lpExistingFileName,
                LPSECURITY_ATTRIBUTES lpSecurityAttributes);
WINBASEAPI WINBOOL WINAPI
CreateHardLinkW(LPCWSTR lpFileName, LPCWSTR lpExistingFileName,
                LPSECURITY_ATTRIBUTES lpSecurityAttributes);
...
WINADVAPI WINBOOL WINAPI CreateRestrictedToken(
