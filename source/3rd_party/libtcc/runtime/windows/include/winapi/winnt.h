...
#define RTL_PADDING_BETWEEN_FIELDS(T, F1, F2)                                  \
    ((FIELD_OFFSET(T, F2) > FIELD_OFFSET(T, F1))                               \
         ...
         : (FIELD_OFFSET(T, F1) - FIELD_OFFSET(T, F2) -                        \
            RTL_FIELD_SIZE(T, F2)))
...
NTSYSAPI
VOID __cdecl RtlRestoreContext(PCONTEXT ContextRecord,
...
BOOLEAN RtlAddFunctionTable(PRUNTIME_FUNCTION FunctionTable, DWORD EntryCount,
                            ULONGLONG BaseAddress, ULONGLONG TargetGp);
BOOLEAN RtlInstallFunctionTableCallback(DWORD64 TableIdentifier,
                                        DWORD64 BaseAddress, DWORD Length,
                                        DWORD64 TargetGp,
