...
static void *load_data(AFileHandle fh, unsigned long file_offset,
                       unsigned long size) {
    void *data;
...
ST_FUNC int tcc_load_object_file(TCCState *s1, AFileHandle fh,
...
static int tcc_load_alacarte(TCCState *s1, AFileHandle fh, int size,
                             int entrysize) {
...
ST_FUNC int tcc_load_dll(TCCState *s1, AFileHandle fh, const char *filename,
                         int level) {
    ElfW(Ehdr) ehdr;
